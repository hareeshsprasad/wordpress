(self.webpackChunkwebpackWcBlocksFrontendJsonp =
  ...
  [834],
  {
    2050: (e, t, r) => {
                ...
                e.map((e) => {
                  const t = (null == e ? void 0 : e.key) || e.name || "",
                    r =
                      ...
                      (t
                        ? `wc-block-components-product-details__${(0, P.o)(t)}`
                        : "");
      ...
      const M = ({
        ...
        $ = ({ cartItem: e }) => {
          const {
            ...
            { receiveCart: S, ...A } = (0, k.b)(),
            D = (0, m.useMemo)(
              () => ({ context: "summary", cartItem: e, cart: A }),
              [e, A]
            ),
          ...
          const O = (0, g.Z)({ amount: H, precision: V.minorUnit }).getAmount(),
      ...
      r(3086);
      const L = ({ cartItems: e = [] }) => {
          const { isLarge: t, hasContainerWidth: r } = (0, n.N)();
          return r
            ? (0, c.createElement)(
                s.Panel,
                {
                ...
                (0, c.createElement)(
                  ...
                  e.map((e) =>
                    (0, c.createElement)($, { key: e.key, cartItem: e })
                  )
                )
              )
            : null;
