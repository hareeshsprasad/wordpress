  ...
  [514],
  {
    ...
    1459: (e, t, r) => {
                ...
                e.map((e) => {
                  const t = (null == e ? void 0 : e.key) || e.name || "",
                    r =
                      ...
                      (t
                        ? `wc-block-components-product-details__${(0, q.o)(t)}`
                        : "");
                  return (0, a.createElement)(
                    "li",
      ...
      const M = ({
        ...
        return (0, a.createElement)(s.RawHTML, { style: n, className: c }, l);
      };
      var T = r(8752);
      const L = ({
        className: e,
      ...
      var V = r(711);
      const $ = ({ currency: e, saleAmount: t, format: r = "<price/>" }) => {
          ...
          ({ lineItem: e, onRemove: t = () => {}, tabIndex: r }, n) => {
            const {
              ...
              } = e,
              {
                ...
                const { key: r = "", quantity: a = 1 } = t,
                  ...
                  } = (0, y.useDispatch)(b.CHECKOUT_STORE_KEY),
                  [i, m] = (0, s.useState)(a),
                  [p] = (0, u.Nr)(i, 400),
                  d = (0, E.D)(p),
                  { removeItemFromCart: _, changeCartItemQuantity: k } = (0,
                  y.useDispatch)(b.CART_STORE_KEY);
                (0, s.useEffect)(() => m(a), [a]);
              ...
              { dispatchStoreEvent: W } = (0, k.n)(),
              { receiveCart: Y, ...J } = (0, c.b)(),
              z = (0, s.useMemo)(
                () => ({ context: "cart", cartItem: e, cart: J }),
                [e, J]
              ),
              G = (0, w.getCurrencyFromPriceResponse)(V),
              ...
              re = ee.subtract(te),
              ae = re.multiply(U),
              ce = (0, w.getCurrencyFromPriceResponse)(Q);
            let ne = parseInt(Q.line_subtotal, 10);
            (0, v.getSetting)("displayCartPricesIncludingTax", !1) &&
              (ne += parseInt(Q.line_subtotal_tax, 10));
            const le = (0, N.Z)({ amount: ne, precision: ce.minorUnit }),
              oe = M.length ? M[0] : {},
            ...
            return (0, a.createElement)(
              ...
              (0, a.createElement)(
                ...
                se
                  ? (0, a.createElement)(I, { image: oe, fallbackAlt: X })
                  : (0, a.createElement)(
                      "a",
                      { href: F, tabIndex: -1 },
                      (0, a.createElement)(I, { image: oe, fallbackAlt: X })
              ...
              (0, a.createElement)(
                ...
                (0, a.createElement)(
                  ...
                  R
                    ...
                    : !!D && (0, a.createElement)(x, { lowStockRemaining: D }),
                  (0, a.createElement)(
                    "div",
      ...
      r(9510);
      const Z = [...Array(3)].map((_x, e) =>
          (0, a.createElement)(Q, { lineItem: {}, key: e })
        ),
        U = (e) => {
          const t = {};
          return (
